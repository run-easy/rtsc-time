...
impl Instant {
    ...
    #[inline]
    pub unsafe fn unchecked_add(&self, duration: Duration) -> Instant {
        Self(self.0 + (duration.as_nanos() as u64 as f64 / tsc::nanos_per_cycle()) as u64)
    }
    ...
    #[inline]
    pub unsafe fn unchecked_sub(&self, duration: Duration) -> Instant {
        Self(self.0 - (duration.as_nanos() as u64 as f64 / tsc::nanos_per_cycle()) as u64)
    }
